...
- I have spent a lot of time already on this project, and there is still a lot of things I could do and add, some of which I mentioned above, also tests I could probably write, but I can't afford to spend any more time right now, I also have to complete two other assessments this week/weekend, so I hope what I have done is enough.  If there is something else that you really wanted to see, let me know then I will spend a little more time adding it.  
